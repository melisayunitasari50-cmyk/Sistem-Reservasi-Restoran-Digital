...
<head>
    ...
    <style>
        ...
        /* Gaya Tombol Kembali ke Beranda Spesifik (Emas) */
        ...
        .img-menu-wrapper { height: 160px; overflow: hidden; width: 100%; }
        .img-menu-wrapper img { width: 100%; height: 100%; object-fit: cover; }

        .badge-kategori { background-color: #d1fae5 !important; color: #065f46 !important; font-weight: 600; font-size: 0.75rem; }
        .badge-tersedia { background-color: #e6f4ea !important; color: #137333 !important; font-size: 0.75rem; }
        .badge-habis { background-color: #fce8e6 !important; color: #c5221f !important; font-size: 0.75rem; }
        .price-tag { color: #34d399 !important; font-weight: 700; font-size: 1.1rem; }
        .btn-edit-theme { background-color: #fef08a !important; color: #854d0e !important; border: none !important; }
        .btn-edit-theme:hover { background-color: #fde047 !important; color: #854d0e !important; }

        .alert-container-box { position: relative; width: 100%; height: 20px; margin-bottom: 0.5rem !important; }
        .smooth-fly-alert {
            position: absolute !important; top: -10px; left: 0; width: 100%; z-index: 999;
            transition: transform 0.6s cubic-bezier(0.55, 0.055, 0.675, 0.19), opacity 0.5s ease-out !important;
        }
        .smooth-fly-alert.fly-away { opacity: 0 !important; transform: translateY(-50px) !important; }
    </style>
</head>
<body>
    ...
    <div class="container my-5">
        ...
        <div class="alert-container-box">
            @if(session('success'))
                <div class="alert alert-success alert-dismissible border-0 rounded-3 p-3 smooth-fly-alert" role="alert" style="background-color: #dcfce7 !important; color: #15803d !important;">
                    ...
                    <div class="card card-menu h-100">
                        ...
                        <div class="card-body p-3">
                            <div class="d-flex justify-content-between align-items-start mb-2">
                                <h6 class="card-title fw-bold m-0 text-truncate text-white" style="max-width: 60%;" title="{{ $menu->nama_menu }}">{{ $menu->nama_menu }}</h6>
                                <span class="badge badge-kategori px-2 py-1 rounded-2">{{ ucfirst($menu->kategori) }}</span>
                            </div>
                            <p class="card-text text-white-50 small mb-3" style="min-height: 36px; line-height: 1.5; font-size: 0.8rem;">{{ $menu->deskripsi ?? 'Tidak ada deskripsi menu.' }}</p>
                            <div class="d-flex justify-content-between align-items-center pt-2 border-top border-secondary">
                                <h6 class="price-tag m-0">Rp {{ number_format($menu->harga < 1000 ? $menu->harga * 1000 : $menu->harga, 0, ',', '.') }}</h6>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (alertElement) {
                setTimeout(function() {
                    ...
                    setTimeout(function() { alertElement.remove(); }, 600); 
                }, 1000); 
            }
        });
    </script>
